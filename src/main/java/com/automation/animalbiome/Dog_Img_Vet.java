...
public class Dog_Img_Vet {
	...
	private void vetDetails() throws Exception {
		...
		driver.findElement(By.xpath(prop.getProperty("Veterinary_clinic_name"))).
		  ...
		  driver.findElement(By.xpath(prop.getProperty("vet_street"))).sendKeys(prop.getProperty("vet_street_info")); Thread.sleep(5000); 
		  WebElement m=driver.findElement(By.xpath(prop.getProperty("vet_footer")));
		  JavascriptExecutor js1 = (JavascriptExecutor)driver;
		  js1.executeScript("arguments[0].scrollIntoView(true);", m);
		  Thread.sleep(5000);
		  driver.findElement(By.xpath(prop.getProperty("vet_postalcode"))).sendKeys(prop.getProperty("vet_postalcode_info"));
		  Select s3=new Select(driver.findElement(By.xpath(prop.getProperty("vet_country_dropdown")))); 
		  ...
		  logger.info("Successfully Completed the Dog  Profile with image and vet details");
	}
	...
	private void AboutMyPet() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath(prop.getProperty("pet_years"))).sendKeys("5");
	...
	/*
	 * WebDriver driver = Instance.getInstance(); Properties prop =
	 * PropertiesFile.readPropertyFile("Dog_Img_Vet.properties");
	 */
...
s1.selectByIndex(2);
 Select s2=new
  Select(driver.findElement(By.xpath(prop.getProperty("frequency_dropdown"))));
  s2.selectByIndex(2);
  js1.executeScript("window.scrollBy(0,500)","" ); Thread.sleep(5000);
  driver.findElement(By.xpath(prop.getProperty("decription"))).sendKeys(prop.
  getProperty("decription_info"));
  driver.findElement(By.xpath(prop.getProperty("confirm_button"))).click();
  Thread.sleep(5000);
