...
public class Cat_Img_Vet {
	final Logger logger = LogManager.getLogger(Cat_Img_Vet.class);
	AnimalBiomeInitializer initializer = new AnimalBiomeInitializer("Cat_Img_Vet.properties");
	WebDriver driver = initializer.getWebDriver();
	Properties prop = initializer.getProperties();
	
	@Test(priority=17, enabled=true)
public void Addcat_img_vet() throws Exception {
