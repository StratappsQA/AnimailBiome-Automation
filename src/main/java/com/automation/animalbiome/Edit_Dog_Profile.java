	...
	public class Edit_Dog_Profile {
		...
		public void edit_dog_profile() throws Exception {
			...
			logger.info("Started editing the Dog Profile through the Dashbpoard");
			  ...
			  driver.findElement(By.xpath(prop.getProperty("Edit_pet_searchbutton"))).
			  sendKeys(("Booster"));
			  driver.findElement(By.xpath(prop.getProperty("Edit_pet_search_icon"))).click(); 
			  Thread.sleep(8000); Actions act = new Actions(driver);
			  ...
			  Thread.sleep(8000); JavascriptExecutor js6 = (JavascriptExecutor) driver;
			  js6.executeScript("window.scrollBy(0,500)",""); 
			  Thread.sleep(3000);
			  driver.findElement(By.xpath(prop.getProperty("p_edit_nextbutton"))).click();
			  Thread.sleep(2000);
			  driver.findElement(By.xpath(prop.getProperty("p_edit_nextbutton"))).click();
			  Thread.sleep(3000); js6.executeScript("window.scrollBy(0,600)","");
			  Thread.sleep(5000);
			  ...
			  Thread.sleep(1000);
			  driver.findElement(By.xpath(prop.getProperty("p_edit_other_diet_child"))).
			  click(); 
			  js6.executeScript("window.scrollBy(0,500)", "");
			  driver.findElement(By.xpath(prop.getProperty("p_edit_none_physical"))).click();
			  
			  WebElement ele =
			  driver.findElement(By.xpath(prop.getProperty("p_edit_none_symptoms1")));
			...
			WebElement element311 = wait1.until(ExpectedConditions
					.elementToBeClickable(By.xpath("(//div[@class='flip-card-back'])[last()]/div/button[2]")));
			((JavascriptExecutor) driver).executeScript("arguments[0].click();", element311);
