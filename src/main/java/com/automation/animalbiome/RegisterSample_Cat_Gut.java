...
public class RegisterSample_Cat_Gut {
	final Logger logger = LogManager.getLogger(RegisterSample_Cat_Gut.class);
	WebDriver driver = Instance.getInstance();
	Properties prop = PropertiesFile.readPropertyFile("RegisterSample_Cat_Gut.properties");
	
	@Test(priority=12, enabled=true)
public void register_sample_cat_gut() throws Exception {	
...
for(int i=0;i<li.size()-1;i++)
{
 ...
 JavascriptExecutor js12 = (JavascriptExecutor) driver;
  ...
  Thread.sleep(5000); 
  driver.findElement(By.xpath(prop.getProperty("p_sampleid"))).sendKeys("TC6G6V");
  ...
  driver.findElement(By.xpath(prop.getProperty("p_date_select"))).click();
   ...
   driver.findElement(By.xpath(prop.getProperty("p_consistancy_image"))).click();
	 ...
	 driver.findElement(By.xpath(prop.getProperty("p_cat_medication_Antihistamines"))).click();
	  ...
	  Thread.sleep(1000);
	  driver.findElement(By.xpath(prop.getProperty("p_cat_acutegastrick"))).click();
	  driver.findElement(By.xpath(prop.getProperty("p_diet_wet/canned"))).click();
	  js12.executeScript("window.scrollBy(0,900)","" );
	  Thread.sleep(1000);
	 driver.findElement(By.xpath(prop.getProperty("symptoms_skinissues"))).click();
	  ...
	  Thread.sleep(10000);
	  logger.info("Gut Sample for Cat Registered Successfully");

	}
	public static void main(String[] args) throws SQLException {

		try {
			String query1 = "update assessments_assessment set status ='unregistered' where sample_registration_key ='TC6G6V'";
