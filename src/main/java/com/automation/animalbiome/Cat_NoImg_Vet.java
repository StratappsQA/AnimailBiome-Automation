...
public class Cat_NoImg_Vet {
	final Logger logger = LogManager.getLogger(Cat_NoImg_Vet.class);
	AnimalBiomeInitializer initializer = new AnimalBiomeInitializer("Cat_NoImg_Vet.properties");
	WebDriver driver = initializer.getWebDriver();
	Properties prop = initializer.getProperties();
	
	@Test(priority=18, enabled=true)
public void Addcat_Noimg_vet() throws Exception {
