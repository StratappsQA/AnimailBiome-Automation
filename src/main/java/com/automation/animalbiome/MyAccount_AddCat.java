...
import java.util.Properties;
	...
	public class MyAccount_AddCat {
		final Logger logger = LogManager.getLogger(AddPet_NewUser.class);
		AnimalBiomeInitializer initializer = new AnimalBiomeInitializer("MyAccount_AddCat.properties");
		WebDriver driver = initializer.getWebDriver();
		Properties prop = initializer.getProperties();
		
		
		@Test(priority=12, enabled=true)
	public void my_account_addcat() throws Exception {
		...
		private void myaccount_userprofile() throws Exception {
			...
			logger.info("Started Creating the Cat Profile for exist User with my account");
