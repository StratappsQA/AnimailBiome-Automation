...
public class Register_Sample_Dog_Oral {
	final Logger logger = LogManager.getLogger(Register_Sample_Dog_Oral.class);
	
	WebDriver driver = Instance.getInstance();
	Properties prop = PropertiesFile.readPropertyFile("Register_Sample_Dog_Oral.properties");
	
	@Test(priority=11, enabled=true)
public void register_sample_dog_oral() throws Exception {	
Thread.sleep(8000);	
...
Thread.sleep(5000); 
driver.findElement(By.xpath(prop.getProperty("p_sampleid"))).sendKeys("MJNMHM");
...
driver.findElement(By.xpath(prop.getProperty("p_animalbiome_suppliments_gutmaintance"))).click();
...
driver.findElement(By.xpath(prop.getProperty("p_physical_chronic"))).click();
...
Thread.sleep(10000);
logger.info("Oral sample for Dog Registered Successfully");

	}
	public static void main(String[] args) throws SQLException {

		try {
			String query1 = "update assessments_assessment set status ='unregistered' where sample_registration_key ='MJNMHM'";
